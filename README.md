...
Génération d'un signal PWM à 10 kHz pour piloter le moteur et mise en place d'un filtre RRC (constante de temps de 10 ms) pour modéliser le comportement du moteur [71, Conversation History].
